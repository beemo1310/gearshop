                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->first('a_name') ? 'has-error' : '' }} ">
                            ...
                            <div>
                                <input type="text" maxlength="180" class="form-control"  placeholder="Tiêu đề bài viết" name="a_name" value="{{ old('a_name',isset($article) ? $article->a_name : '') }}">
                                <span class="text-danger "><p class="mg-t-5">{{ $errors->first('a_name') }}</p></span>
                            </div>
                        </div>
