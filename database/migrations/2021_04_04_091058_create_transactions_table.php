...
class CreateTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transactions', function (Blueprint $table) {
            $table->id();
            $table->integer('tst_user_id')->nullable()->default(0)->index();
            ...
            $table->integer('tr_city_id')->default(0)->index();
            $table->integer('tr_district_id')->default(0)->index();;
            $table->integer('tr_street_id')->default(0)->index();;
            $table->timestamps();
        });
    }
